...
export const Info = () => {
  return (
    <Element name="about">
      <div className={cx('bg-lightgrey px-4 py-0', 'lg:py-8 xl:px-24')}>
        <div className={cx('py-8 md:py-8')}>
          ...
          <p className="font-caveat text-center text-gray-800 transition-width md:text-20 md:font-semibold">
            A ROADMAP TO TEACHING AND LEARNING DIVERSITY FOR THE NEXT
            GENERATION.
          </p>
        </div>
        ...
        <div className="flex flex-wrap pb-8 sm:py-12 lg:flex-nowrap lg:p-0">
          ...
          <div className="my-auto flex flex-col gap-y-4">
            <div>
              ...
              <ul className="font-poppins mx-4 list-disc font-light text-black">
                <li>
                  ...
                  social group. These biases result in stereotypes that are
                  often untrue.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="font-poppins mx-4 list-disc font-light text-black">
                <li>
                  ...
                  harm self-esteem and has resulted in the underrepresentation
                  of diverse groups in fields like STEM, medicine, and more.
                </li>
                <li>
                  Rachel wanted to study medicine, but an offhand comment
                  brought on feelings of self-doubt. How did she overcome it?
                  <br />
            ...
            <div>
              ...
              <ul className="font-poppins mx-4 list-disc font-light text-black">
                <li>
                  Occurs when individuals facing similar challenges come
                  together as a group to give and receive help based on their
                  shared lived experiences.
                </li>
                <li>
                  Chrisel's entry into college life was shaped by the
                  Educational Opportunity Program. How has it helped her
                  succeed?
                  <br />
            ...
            <div>
              ...
              <ul className="font-poppins mx-4 list-disc font-light text-black">
                ...
                <li>
                  Agata came to the US from Poland as a teenager and had to
                  build her new life from the ground up in English. Did she let
                  that stop her?
                  <br />
