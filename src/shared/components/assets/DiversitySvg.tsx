...
interface DiversitySvgProps {
  className?: string;
}
export const DiversitySvg = ({ className }: DiversitySvgProps) => {
  return (
    <svg
      version="1.1"
